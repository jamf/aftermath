...
class LSQuarantine {
    ...
    func getLSQuarantine() {
        ...
        if sqlite3_open(fileURL.path, &db) == SQLITE_OK {
            ...
            let queryString = "select LSQuarantineTimeStamp, LSQuarantineAgentName, LSQuarantineAgentBundleIdentifier, LSQuarantineDataURLString, LSQuarantineOriginURLString, LSQuarantineSenderName, LSQuarantineSenderAddress from LSQuarantineEvent order by LSQuarantineTimeStamp"
            ...
            if sqlite3_prepare_v2(db, queryString, -1, &queryStatement, nil) == SQLITE_OK {
                ...
                while sqlite3_step(queryStatement) == SQLITE_ROW {
                    ...
                    if col1 != nil{
                        LSQuarantineTimeStamp = String(cString: col1!)
                    }
